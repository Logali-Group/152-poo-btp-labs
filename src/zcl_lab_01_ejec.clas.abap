...
class zcl_lab_01_ejec implementation.
  ...
  method if_oo_adt_classrun~main.
    ...
    data(go_account) = new zcl_lab_10_account(  ).
...
*    zcl_lab_09_work_record=>open_new_record( exporting iv_date       = cl_abap_context_info=>get_system_date( )
*                                                       iv_first_name = 'John'
*                                                       iv_last_name  = 'Smith' ).


*     data(go_student) = new zcl_lab_08_student(  ).
*
...
*    data(go_elements) = new zcl_lab_07_elements(  ).
*
*    data gs_object type zcl_lab_07_elements=>ty_elem_objects.
*
...
*    out->write( zcl_lab_07_elements=>lc_light_speed ).
*    out->write( zcl_lab_07_elements=>lc_permeability ).
*    out->write( zcl_lab_07_elements=>lc_permittivity ).
*    out->write( zcl_lab_07_elements=>lc_mass_electron ).

*    data(go_constructors) = new zcl_lab_06_constructor(  ).
*
*    out->write( zcl_lab_06_constructor=>log ).
